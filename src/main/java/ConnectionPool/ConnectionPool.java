...
public final class ConnectionPool {
    ...
    private void clearConnectionQueue() {
        try {
            ...
            closeConnectionsQueue(connectionQueue); } catch (SQLException e) {
...
private class PooledConnection implements Connection { private Connection connection;
    ...
    public void close() throws SQLException {
                ...
                public Array createArrayOf (String typeName, Object[]elements) throws SQLException {
                    return connection.createArrrayOf(typeName, elements);
                }
                @Override
